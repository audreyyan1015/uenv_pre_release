...
./scripts/benchmark/olymmath/run_olymmath_uenv_baseline.sh 2>&1 | tee "$OUT/run.log"
```
...
TIMEOUT_SECONDS=7200 \
CLIENT_TIMEOUT_SECONDS=7800 \
./scripts/benchmark/olymmath/run_olymmath_uenv_baseline.sh 2>&1 | tee "$OUT/resume_failed.log"
```
