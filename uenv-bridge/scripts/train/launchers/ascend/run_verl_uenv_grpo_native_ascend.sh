...
Usage:
  SERVER_ADAPTER_CORE_ENDPOINT=<server-core-host:port> ./scripts/train/launchers/ascend/run_verl_uenv_grpo_native_ascend.sh
...
Quick dry check without NPU or adapter core:
  ...
  ./scripts/train/launchers/ascend/run_verl_uenv_grpo_native_ascend.sh
...
ensure_file_exists "${REPO_DIR}/scripts/train/wrappers/run_verl_main_ppo.py" "VeRL PPO wrapper not found"
...
VERL_CMD=(
  "${PYTHON_BIN}" "${REPO_DIR}/scripts/train/wrappers/run_verl_main_ppo.py"
