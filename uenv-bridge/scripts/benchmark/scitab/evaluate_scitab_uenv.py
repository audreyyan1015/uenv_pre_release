...
from scitab_utils import LABELS, build_prompt, compute_metrics, load_scitab, parse_label
from obs_run import (
    add_obs_args,
...
def main() -> int:
    ...
    parser.add_argument("--prompt-style", default="official", choices=["default", "official", "strict_label"])
