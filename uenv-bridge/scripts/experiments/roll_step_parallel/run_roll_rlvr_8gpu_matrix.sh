...
Examples:
  ROLL_MODE=sync ./scripts/experiments/roll_step_parallel/run_roll_rlvr_8gpu_matrix.sh
  ROLL_MODE=async_training ROLL_ASYNC_GENERATION_RATIO=2 ./scripts/experiments/roll_step_parallel/run_roll_rlvr_8gpu_matrix.sh
  ROLL_MODE=async_training ROLL_ASYNC_GENERATION_RATIO=2 ROLL_GPU_SPLIT=2x6 ./scripts/experiments/roll_step_parallel/run_roll_rlvr_8gpu_matrix.sh
EOF
}
